...
<div class="b-filter__filter">
    ...
    <form class="b-filter__form" name="<?= $arResult["FILTER_NAME"] . "_form" ?>"
          action="<?= $arResult["FORM_ACTION"] ?>" method="get">
        ...
        <? foreach ($arResult["ITEMS"] as $key => $arItem) {
                        ...
                        <? foreach ($arItem["VALUES"] as $val => $ar): ?>
                            ...
                            <div class="b-checkbox">
                                ...
                                <label class="b-checkbox__name"
                                    ...
                                    <span class="b-checkbox__text"><?= $ar["VALUE"] ?> <?=$ar['ELEMENT_COUNT']?></span>
                                </label>
                            </div>
            ...
            <?endif;?>
        <? } ?>
        <button class="b-button" type="reset">Сбросить фильтр
        </button>
    </form>
</div>
