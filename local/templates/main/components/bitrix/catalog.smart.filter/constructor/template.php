...
<form class="4444 b-constructor js-constructor js-form-validate" method="post"
    ...
    <input type="hidden" name="ajax_add" value="Y">
                                    ...
                                    <label class="b-radio-button__label" for="<?= $ar["CONTROL_ID"] ?>">
                                        <span class="b-radio-button__wrap js-current-el">
                                            <span class="b-radio-button__image">
                                                <span style="background: linear-gradient(0deg, #ffffff, #f8f8f8), url(<?= $ar['FILE']['SRC'] ?>) center center/cover no-repeat;"></span>
                                            </span>
                                            <span class="b-radio-button__text-label">
                                                <?= $ar["VALUE"] ?>
                                            </span>
                                        </span>
